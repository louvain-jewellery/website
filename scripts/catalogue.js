...
const collectionHeroTitle = document.querySelector(
  ".collection-hero-title-text"
);
...
const collectionData = {
  bestSellers: {
    ...
    description:
      "Koleksi unggulan Louvain yang mengutamakan keindahan, detail, serta kualitas dalam setiap desainnya.",
